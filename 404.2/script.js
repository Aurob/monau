...
function create_language_switcher() {
    ...
    setInterval(function(){
        ...
        $('#pnf').html(pnf_translations[translation]);
...
$('body').prepend('<div id="paths_header" style="scrollbar-width: thin; display: flex; overflow-x: auto; width: 100% !important; justify-content: space-between;"></div>');
