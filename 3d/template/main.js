...
var ASM_CONSTS = {
 ...
 161048: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 161131: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 161200: () => { return window.innerWidth; },  
 161230: () => { return window.innerHeight; }
};
