...
(function () {
    ...
    Level.load = function () {
        ...
        var planeY = 200;
        var planeSegments = 50;
        var planeSegmentX = planeX / planeSegments;
        var planeSegmentY = planeY / planeSegments;
    ...
    function updatePlaneTexture() {
        ...
        Engine.planeMesh.material.map.offset.x += Engine.movespeed/Level.speedFraction;
        Engine.planeMesh.material.map.offset.y -= Engine.movespeed/Level.speedFraction;
    }
